...
if (loginStart > -1 && registerEnd > -1) {
  const newContent = `    <!-- Login Page (Hidden initially) -->
    <div id="view-login" class="hidden w-full min-h-screen bg-white dark:bg-[#070B19]">
      <div class="flex min-h-screen flex-col lg:flex-row w-full">
        
        <!-- Left Side: Brand & Abstract -->
        <div class="flex flex-col justify-between w-full lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-slate-900 to-[#0A0F1F] p-8 sm:p-12 lg:px-16 lg:py-12 lg:min-h-screen flex-shrink-0">
          <!-- Ambient Effects -->
          ...
          <!-- Content Message -->
          <div class="relative z-10 max-w-lg my-12 lg:mt-auto lg:mb-20">
        ...
        <div class="flex flex-col justify-center items-center p-6 sm:p-12 w-full lg:w-1/2 flex-1 bg-white dark:bg-[#070B19] relative z-10">
    ...
    <div id="view-register" class="hidden w-full min-h-screen bg-white dark:bg-[#070B19]">
      <div class="flex min-h-screen flex-col lg:flex-row w-full">
        ...
        <div class="flex flex-col justify-between w-full lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-slate-900 to-[#0A0F1F] p-8 sm:p-12 lg:px-16 lg:py-12 lg:min-h-screen flex-shrink-0">
          ...
          <!-- Content Message -->
          <div class="relative z-10 max-w-lg my-12 lg:mt-auto lg:mb-10">
          ...
          <!-- Footer Text -->
          <div class="hidden lg:flex relative z-10 text-slate-500 text-sm items-center gap-4 mt-8">
            &copy; 2026 jagoCV AI
            <span class="w-1 h-1 rounded-full bg-slate-700"></span>
  ...
  console.log("Responsive auth views configured completely cleanly with flex");
} else {
